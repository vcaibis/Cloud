...
public class QuestionEndpoint {
     ...
     *
     * @param serialVersionUID the ID of the entity to be retrieved
     * @return the entity with the corresponding ID
     * @throws NotFoundException if there is no {@code Question} with the provided ID.
     */
    @ApiMethod(
            name = "get",
            path = "question/{serialVersionUID}",
            httpMethod = ApiMethod.HttpMethod.GET)
    public Question get(@Named("serialVersionUID") long serialVersionUID) throws NotFoundException {
        logger.info("Getting Question with ID: " + serialVersionUID);
        Question question = ofy().load().type(Question.class).id(serialVersionUID).now();
        if (question == null) {
            throw new NotFoundException("Could not find Question with ID: " + serialVersionUID);
        }
        return question;
    }
    ...
    public Question insert(Question question) {
        ...
        // You should validate that question.serialVersionUID has not been set. If the ID type is not supported by the
     ...
     *
     * @param serialVersionUID the ID of the entity to be updated
     * @param question         the desired state of the entity
     * @return the updated version of the entity
     * @throws NotFoundException if the {@code serialVersionUID} does not correspond to an existing
     *                           {@code Question}
     */
    @ApiMethod(
            name = "update",
    ...
    public Question update(@Named("serialVersionUID") long serialVersionUID, Question question) throws NotFoundException {
        // TODO: You should validate your ID parameter against your resource's ID here.
        checkExists(serialVersionUID);
        ofy().save().entity(question).now();
     ...
     *
     * @param serialVersionUID the ID of the entity to delete
     * @throws NotFoundException if the {@code serialVersionUID} does not correspond to an existing
     *                           {@code Question}
     */
    @ApiMethod(
    ...
    public void remove(@Named("serialVersionUID") long serialVersionUID) throws NotFoundException {
        checkExists(serialVersionUID);
        ofy().delete().type(Question.class).id(serialVersionUID).now();
        logger.info("Deleted Question with ID: " + serialVersionUID);
    }
    ...
    private void checkExists(long serialVersionUID) throws NotFoundException {
        try {
            ofy().load().type(Question.class).id(serialVersionUID).safe();
